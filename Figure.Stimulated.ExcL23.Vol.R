...
tmp <- subset(test, subset = Annotation.fine %in% c("Exc_L23IT"))
...
pdf(file = "//grid/cheadle_home/qianyu/Epilepsy/manuscript/V5/Figure.Stimulated.L23.pdf", width = 2, height = 2)
print(p1)
