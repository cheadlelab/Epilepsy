...
Allen1 <- subset(Allen1, Annotation == "Astrocyte")
...
Allen2 <- subset(Allen2, Annotation == "Astrocyte")
...
pdf(file = paste0(save_path, "/Figure.Astro.Allen.CD44.pdf"), width = 5, height = 5)
FeaturePlot(
  test, features = c("CD44"),
