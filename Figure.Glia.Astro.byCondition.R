...
pdf(file = "//grid/cheadle_home/qianyu/Epilepsy/manuscript/V5/Figure.RA.Vol.pdf", width = 2, height = 2)
print(p1)
...
pdf(file = "//grid/cheadle_home/qianyu/Epilepsy/manuscript/V5/Figure.RA.GO.pdf", width = 2.2, height = 1.5)
print(p1)
dev.off() # Close the PDF device
